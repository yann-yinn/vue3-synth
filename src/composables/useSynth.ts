 ...
 * - a reactive waveform
 */
export function useOscillatorWithKeyboard(
  ...
  const notes = ref(keyboardMap(state.pitch));
...
function keyboardMap(startNote = 55): Map<string, number> {
